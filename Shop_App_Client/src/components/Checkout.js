                      ...
                      <tbody>
                        {
                          cartData.map((item, index) => {
                            return (<>
                              <tr>
                                <td>
                                  {item.productId[0].pName} <strong className="mx-2">x</strong> {item.quantity}
                                </td>
                                <td>{item.productId[0].pPrice * item.quantity}</td>
                              </tr>
                        ...
                        <tr>
                          ...
                          <td className="text-black" >{totalCart()}</td>
                        </tr>
                        <tr>
                          <td className="text-black font-weight-bold">
                          ...
                          <td className="text-black font-weight-bold"  >
                            <strong {...register('totalamount')} >{totalCart()}</strong>
                          </td>
                        </tr>
